...
GLib was written in C and was developed mainly by GNOME. They wanted to separate it from GTK+ so it could be used by software other than GNOME. It is used for threads and thread programming and it also has features such as warnings, standard macros, and dynamic loading of modules.

*  What are the most important pros and cons of using GLib, as opposed
to another library, or just using core C features?

The main pro of using GLib over using core C features is that because you have access to threads and advanced data structures you will be able to create cleaner and more concise code that does not need to implement as many things explicitly.
